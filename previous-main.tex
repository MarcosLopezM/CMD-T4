...
\savesymbol{rank}
\usepackage{multicol}
\usepackage{nicematrix} % Better matrix handling
\usepackage[hyperref]{ntheorem}
% \usepackage{pdfpages} % Include PDF files
\usepackage{phfqit} % Bra-ket notation
\savesymbol{so}
\usepackage{simples-matrices} % Fast matrix typing
\usepackage{siunitx}
\usepackage{soul}
\usepackage{spbmark} % Custom superscripts and subscripts
\usepackage{standalone}
\usepackage{subfiles}
\usepackage{titling}
\usepackage{tabularray} % Input tables
\usepackage{tasks}
\usepackage{xcolor}
\usepackage{xparse}
\usepackage{xspace}
...
% % Configuración de ambiente para ejercicios extra
% \theoremstyle{break}
% \theoremheaderfont{\Large\normalfont\bfseries}
...
%     \color{customBlue} \hrule width \hsize height 2pt \kern 1mm \hrule width \hsize
%     }
% \newtheorem{exercisex}{Extra}
% \counterwithin{equation}{exercisex}

% \makeatletter
% \LetLtxMacro\old@exercisex\exercisex
% \renewcommand*{\exercisex}{%
%   \@ifnextchar[{%
%     \exercisex@opt
%   }{%
%     \old@exercisex
...
% \def\exercisex@opt[#1]{%
%   \old@exercisex[{#1}]%
%   \exercisex@bookmark{: #1}%
% }
% \newcommand*{\exercisex@bookmark}[1]{%
%   \bookmark[dest=\@currentHref]{Extra \theexercisex#1}%
% }
% \makeatother
...
\hypersetup{
    ...
    pdfsubject={Materia},%
    pdfkeywords={Facultad de Ciencias, UNAM},%
    unicode=true%
}
...
\newcommand*{\homeworknumber}{Examen de reposición}
\newcommand*{\name}{Marcos López Merino}
\DTMsavedate{duedate}{2023-12-12}
